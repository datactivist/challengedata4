...
## JOUR 1 – DIAGNOSTIC
 ...
 Nous nous sommes connectés à la plate-forme de Gather Town (malgré quelques problèmes de Wifi!), puis nous avons lu le questionnaire et posé nos questions à Arthur (sur le vocabulaire et les points qui nous paraissaient flous). Nous avons ensuite pris contact avec les référents de la mairie d’Épinal.
...
* Pour le moment, la commune ne bénéficie pas d’un budget spécifique dédié à l’open data. Une quantification du coût devra être effectuée dans les années à venir, pour ensuite définir un tel budget. 
...
L’objectif de la journée d’aujourd’hui est de nettoyer, rendre présentable, lisible et exploitables les données que nous avons récoltées sur les différentes thématiques.
...
**Par rapport aux données sur les effectifs scolaires :**
...
**Par rapport aux données sur les élus :**
...
**Par rapport aux données sur les prénoms :**
...
**Par rapport aux données sur les effectifs de la petite enfance :**
...
**Par rapport aux données de l’état civil :**
...
Le bilan de la mise en qualité des données et leur traitement est disponible sur le document suivant : 
...
L’objectif d’aujourd’hui est de préparer la publication des données de la ville d’Epinal et de l’agglomération. Nous interagissons donc beaucoup avec nos interlocuteurs, Michel et Prosper, afin de leur faire valider nos fichiers de données. 
...
Ainsi, nous préparons divers supports textuels rassemblés dans un document : nos messages sont courts, incisifs,percutants afin de capter un maximum l’attention du lecteur et sont destinés aux réseaux sociaux avec de nombreux émojis. 
...
Lien de nos supports écrits et visuels de communication : 
<a href="https://docs.google.com/document/d/1Z-ezAkLk7sqaQapRJFqSqf5YRAci4_LKKalwnlD4u7Y/edit">https://docs.google.com/document/d/1Z-ezAkLk7sqaQapRJFqSqf5YRAci4_LKKalwnlD4u7Y/edit</a>



## JOUR 5 – VALORISATION

L’objectif d’aujourd’hui est de produire quelques visualisations simples à partir des données publiées de la ville d’Epinal et de l’agglomération. 
...
**Datavisualisation des effectifs scolaires :**
...
**Datavisualisation de la liste des élus :** 
...
**Datavisualisation de la liste des établissements de petite enfance :**
